...
def od_hod():
    ...
    if employee:
        ...
        frappe.sendmail(
                recipients=['sarath.v@groupteampro.com','arockia.k@groupteampro.com','sivarenisha.m@groupteampro.com','anil.p@groupteampro.com'],
                subject='On Duty Application Report',
                message="""Dear Sir,<br><br>
                        Kindly Find the list of On Duty Application waiting for your Approval:<br>{0}
                        """.format(staff)
...
def late_entry_mail_alert():
    ...
    if attendance:	
        frappe.sendmail(
                ...
                recipients=['sarath.v@groupteampro.com','arockia.k@groupteampro.com', 'dilek.ulu@irecambioindia.com', 'hr@irecambioindia.com', 'prabakar@irecambioindia.com', 'deepak.krishnamoorthy@irecambioindia.com', 'anil.p@groupteampro.com','sivarenisha.m@groupteampro.com'],
