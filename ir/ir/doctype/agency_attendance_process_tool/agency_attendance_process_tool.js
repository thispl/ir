...
frappe.ui.form.on("Agency Attendance Process Tool", {
	refresh(frm) {
        frm.disable_save()
			...
			function () {
				frappe.confirm('Are you sure you want to Submit the Attendance?',
                    () => {
                        ...
                        frappe.call({
                            method: 'ir.ir.doctype.agency_attendance_process_tool.agency_attendance_process_tool.enqueue_create_attendance',
                            args: {
