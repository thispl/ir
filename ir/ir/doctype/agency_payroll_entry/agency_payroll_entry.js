...
frappe.ui.form.on('Agency Payroll Entry', {
	onload: function (frm) {
	...
	add_bank_entry_button: function (frm) {
		frappe.call({
			method: 'ir.ir.doctype.agency_payroll_entry.agency_payroll_entry.payroll_entry_has_bank_entries',
			args: {
				'name': frm.doc.name,
	...
	setup: function (frm) {
		...
		frm.set_query('employee', 'employees', () => {
			...
			return {
				query: "ir.ir.doctype.agency_payroll_entry.agency_payroll_entry.employee_query",
	...
	get_employee_filters: function (frm) {
		...
		let fields = ['company', 'start_date', 'end_date', 'payroll_frequency', 'payroll_payable_account',
			'currency', 'department', 'branch', 'designation', 'salary_slip_based_on_timesheet','grade','custom_agency_name','custom_employment_type'];
	...
	custom_agency_name: function (frm) {
		frm.events.clear_employee_table(frm);
	},
	branch: function (frm) {
		frm.events.clear_employee_table(frm);
	...
	set_start_end_dates: function (frm) {
		if (!frm.doc.salary_slip_based_on_timesheet) {
			frappe.call({
				method: 'ir.ir.doctype.agency_payroll_entry.agency_payroll_entry.get_start_end_dates',
				args: {
	...
	set_end_date: function (frm) {
		frappe.call({
			method: 'ir.ir.doctype.agency_payroll_entry.agency_payroll_entry.get_end_date',
			args: {
