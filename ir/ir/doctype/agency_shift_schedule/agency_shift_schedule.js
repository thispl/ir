...
frappe.ui.form.on('Agency Shift Schedule', {
	refresh: function (frm) {
		frappe.breadcrumbs.add("Home","Agency Shift Schedule");
		...
		// })
			...
			// 	frappe.call({
			// 		"method": "ir.ir.doctype.agency_shift_schedule.agency_shift_schedule.enqueue_shift_assignment",
			// 		"args":{
			// 			"file" : frm.doc.upload,
	...
	get_template: function (frm) {
		window.location.href = repl(frappe.request.url +
			...
			cmd: "ir.ir.doctype.agency_shift_schedule.agency_shift_schedule.get_template",
			from_date: frm.doc.from_date,
			to_date: frm.doc.to_date,
