...
frappe.ui.form.on("Attendance Summary", {
	...
	get_from_to_dates(frm){
		frappe.call({
			"method": "ir.ir.doctype.attendance_summary.attendance_summary.get_from_to_dates",
			"args":{
				"month" : frm.doc.month,
				"year" : frm.doc.year
			},
    ...
    get_data_system(frm) {
		if (frm.doc.employee_id) {
			frappe.call({
				method: "ir.ir.doctype.attendance_summary.attendance_summary.get_data_system",
				args: {
